...
namespace POS.Api.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        {
            var response = await _categoryApplication.RegisterCategoty(requestDto);
            return Ok(response);
        }
        ...
        {
            var response = await _categoryApplication.EditCategoty(categoryId, requestDto);
            return Ok(response);
        }
        ...
        {
            var response = await _categoryApplication.RemoveCategoty(categoryId);
            return Ok(response);
        }
    }
}
