...
namespace POS.Application.Services
{
    public class CategoryApplication : ICategoryApplication
    {
        ...
        public async Task<BaseResponse<bool>> RegisterCategoty(CategoryRequestDto requestDto)
        {
        ...
        public async Task<BaseResponse<bool>> EditCategoty(int categoryId, CategoryRequestDto requestDto)
        {
            var response = new BaseResponse<bool>();
        ...
        public async Task<BaseResponse<bool>> RemoveCategoty(int categoryId)
        {
            var response = new BaseResponse<bool>();
